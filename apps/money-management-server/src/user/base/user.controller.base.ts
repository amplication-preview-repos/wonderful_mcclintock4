...
import { MoneyFindManyArgs } from "../../money/base/MoneyFindManyArgs";
import { Money } from "../../money/base/Money";
import { MoneyWhereUniqueInput } from "../../money/base/MoneyWhereUniqueInput";
...
export class UserControllerBase {
  ...
  async findMonies(
    ...
    const query = plainToClass(MoneyFindManyArgs, request.query);
    const results = await this.service.findMonies(params.id, {
      ...query,
      select: {
        amount: true,
        createdAt: true,
  ...
  async connectMonies(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MoneyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      monies: {
        connect: body,
  ...
  @common.Delete("/:id/monies")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectMonies(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: MoneyWhereUniqueInput[]
  ): Promise<void> {
    const data = {
